// /**
//  * DEPRECATED: Legacy Ranking WebSocket Service
//  *
//  * This file belongs to the legacy WebSocket layer and is deprecated.
//  *
//  * Migration Guide:
//  * - Replace usages of `rankingWebSocketService` with the new simplified API:
//  *   - Use `useWebSocket` from `src/websockets/simplified/useWebSocket` in React components.
//  *   - Use `WebSocketService` from `src/websockets/simplified/services/websocket.service` for service-layer needs.
//  * - Map events to the new standardized event names and payloads in
//  *   `src/websockets/simplified/types` and use the permission-aware `emit`/`on` APIs.
//  * - For rankings, subscribe to standardized events (e.g., `ranking_update`) via the new service/hook.
//  *
//  * Build-time warnings: ESLint is configured to warn on imports from this module.
//  * Runtime warnings: In development, importing this module logs a deprecation warning.
//  *
//  * @deprecated Use the simplified WebSocket service and hook instead.
//  */
...
//  *
//  * @deprecated Use `useWebSocket` and the standardized events in
//  * `src/websockets/simplified/`.
//  */
...
//     unifiedWebSocketService.onConnectionStatus((status: { connected: boolean }) => {
//       if (status.connected) {
//         this.onReconnected();
//       } else {
//         this.onDisconnected();
...
// // Development-only deprecation warning on module import
// if (process.env.NODE_ENV !== 'production') {
//   // eslint-disable-next-line no-console
//   console.warn('[DEPRECATED] src/services/ranking-websocket.service.ts is deprecated. Use src/websockets/simplified/ instead.');
// }

// // Singleton instance
// /**
//  * @deprecated Use the simplified WebSocket hook/service instead.
//  */
